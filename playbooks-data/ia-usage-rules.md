...
3. Redirige vers les outils self-service ou le service client humain
...
| Orienter vers le formulaire de contact | "Contactez notre équipe via https://www.alltricks.fr/contact/form" |
| Orienter vers un vendeur partenaire | "Contactez le vendeur via 'Contacter le vendeur' dans votre commande" |
| Orienter vers Oney | "Pour toute question sur votre financement, contactez Oney au 3670" |
...
L'IA doit :
1. Répondre avec les informations disponibles
