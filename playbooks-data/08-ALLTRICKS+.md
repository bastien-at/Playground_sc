...
## PLB-008 - Informations & conditions Alltricks+
...
- **L’IA peut répondre seule ?**  
  Oui, pour expliquer l’offre, les avantages et les conditions.

- **Accès données nécessaire ?**  
  Non, réponse générale.

- **Cas à escalader d’office** :
  - Demande de remboursement liée à rétractation contestée
  - Litige juridique / mention avocat / plainte
  - Suspicion d’abus/fraude ou suspension du compte +
